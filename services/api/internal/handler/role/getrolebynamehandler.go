...
func GetRoleByNameHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetRoleByNameReq
		if err := httpx.Parse(r, &req); err != nil {
			response.FailByArgsErr(w)
			return
		}

		l := role.NewGetRoleByNameLogic(r.Context(), svcCtx)
		resp, err := l.GetRoleByName(&req)
		if err != nil {
